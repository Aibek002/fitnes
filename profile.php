        ...
        <?php if (isset($_SESSION['name'])) : ?>
            <div class="edit-profile">
                ...
                <div class="username">
                    ...
                    <div class="edit-profiles">Age : <?php echo $_SESSION['age']; ?><br>Goal : <?php echo $_SESSION['goaltext']; ?></div>
                </div>
                <a class='editSvg' href="nutrition-calculator.php"> <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="info-users">
                ...
                <div class="height">
                    <div class="first-item">
                        ...
                        <p class="info">
                            <?php echo $_SESSION['age']; ?> <span>yrs</span></p>
                    </div>
                ...
                <div class="weight">
                    <div class="first-item">
                        ...
                        <p class="info"><?php echo $_SESSION['weight']; ?><span> kg</span></p>
                    </div>
                ...
                <div class="gender">
                    <div class="first-item">
                        ...
                        <p class="info">
                            <?php echo $_SESSION['height']; ?> <span> cm</span></p>
                    </div>
                ...
                <div class="bodyfat">
                    <div class="first-item">
                        ...
                        <p class='info-long'><?php echo $_SESSION['bodyfat']; ?></p>
                    </div>
                ...
                <div class="activatyLevel">
                    <div class="first-item">
                        ...
                        <p class='info-long'><?php echo $_SESSION['acivityLevel']; ?></p>
                    </div>
                ...
                <div class="information-metobalitic">
                    <div class="firsts-item">
                        ...
                        <p class="infos"><?php echo (int) $_SESSION['Carbohydrates']; ?> <span>g</span></p>

                    </div>

                    <div class="seconds-item">
                        <p class="title-info">Protein : </p>
                        <p class="infos"><?php echo (int) $_SESSION['Protein']; ?><span> g</span></p>
                    </div>
                    <div class="thirds-item">
                        <p class="title-info">Metabolic</p>
                        <p class="infoss"><?php echo (int) $_SESSION['dayKcall']; ?> <span> kcal/day</span></p>
                    </div>
                    <div class="fourths-item">
                        <p class="title-info">Fat</p>
                        <p class="infos"><?php echo (int) $_SESSION['Fat']; ?> <span> g</span></p>
                    </div>
