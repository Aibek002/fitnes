...
<body>
    ...
    <div class="height">
       <div class="first-item"><p class="title-info">Age</p><p class="info"><? echo $_SESSION['age']; ?> <span>yrs</span></p></div>
       <div class="second-item"><img src="./assets/images/age.png" alt=""></div>
    </div>
    <div class="weight">
    <div class="first-item"><p class="title-info">Weight</p><p class="info"><? echo $_SESSION['weight']; ?><span> kg</span></p></div>
       <div class="second-item"><img src="./assets/images/weight.png" alt=""></div>
    </div>
    <div class="gender">
    <div class="first-item"><p class="title-info">Height</p><p class="info"><? echo $_SESSION['height']; ?> <span> cm</span></p></div>
       <div class="second-item"><img src="./assets/images/height.png" alt=""></div>
    </div>
    <div class="age">
    <div class="first-item"><p class="title-info">Gender</p><p class="info-gender"><? echo $_SESSION['gender']; ?></p></div>
       <div class="second-item"><img src="./assets/images/gender.png" alt=""></div>
    </div>
    <div class="bodyfat">
        <div class="first-item"><p class='title-info-long'>Body fat :</p><p class='info-long'><? echo $_SESSION['bodyfat']; ?></p></div>
        <div class="second-items"><img class="long-image-first" src="./assets/images/bodyfat.png" alt=""></div>
       
    </div>
    <div class="activatyLevel">
    <div class="first-item"><p class='title-info-long'>Level activity :</p><p class='info-long'><? echo $_SESSION['acivityLevel']; ?></p></div>
