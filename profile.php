...
<body>
    ...
    <div class="info-users">
        ...
        <div class="height">
            <p>Height <br><strong><? echo $_SESSION['height']; ?></strong></p> <img class="a" src="assets\images\height.png" alt="">
        </div>
        <div class="weight">
            <p>Weight : <br> <strong><? echo $_SESSION['weight']; ?></strong><span class="span">kg</span></p><img class="b" src="assets\images\weight.png" alt="">
        </div>
        <div class="gender">
            <p>Gender : <br> <strong><? echo $_SESSION['gender']; ?></strong></p><img class="c" src="./assets/images/gender.png" alt="">
        </div>
        <div class="age">
            <p>Age : <br><strong><? echo $_SESSION['age']; ?></strong> <span class="span">years</span></p> <img class="d" src="assets\images\age.png" alt="">
        </div>
        <div class="bodyfat">
            <p>Body Fat :<br> <strong><? echo $_SESSION['bodyfat']; ?></strong></p><img class="e" src="assets\images\bodyfat.png" alt="">
        </div>
        <div class="activatyLevel">
            <p>Level : <br><strong><? echo $_SESSION['acivityLevel']; ?></strong></p><img class="ff" src="assets\images/GirlRunning.png" alt="">
        </div>
    ...
    <div class="box">
        ...
        <div class="first">
            <div class="f">
                <div class="icon"> <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
