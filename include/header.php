    ...
    <ul class="nav nav-pills">
      ...
      <?php else : ?>
        <?php if ($_SERVER['REQUEST_URI'] === '/login.php') : ?>
          <li class="nav-item"><a href="register.php" class="nav-link active">Sign up</a></li>
          <hr />
          <?php elseif ($_SERVER['REQUEST_URI'] === '/register.php') : ?>
            <li class="nav-item"><a href="login.php" class="nav-link active">Sign in</a></li>
        <?php else : ?>
          <li class="nav-item"><a href="register.php" class="nav-link active">Sign in</a></li>
          <hr />
          <li class="nav-item"><a href="login.php" class="nav-link active">Sign up</a></li>
        <?php endif; ?>
      <?php endif; ?>
